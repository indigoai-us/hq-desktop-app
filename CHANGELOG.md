...
- When two people in the @mention list share a name, the list now always shows something next to each one — their company, their email, or a short id when neither is known — so two identical, unpickable entries for different people can no longer appear.
