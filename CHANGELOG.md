...
- On a Mac, HQ now makes sure its own copy of Git is ready before an HQ update starts. Updates no longer fail when macOS falls back to the system copy of Git.
