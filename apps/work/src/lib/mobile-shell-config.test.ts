 ...
 * Those placeholders were committed once and were indistinguishable in review
 * from real icons — the app would have shipped wearing the wrong logo. So the
 * generated bytes are gitignored and every mobile entry point regenerates them
 * from the single committed source image instead.
 *
