...
describe('error classification is a closed set', () => {
  it.each([
    ...
    ['CONTINUATION_NO_ATTEMPT', 'expired'],
    ['CONTINUATION_ATTEMPT_OVER', 'expired'],
    ['CONTINUATION_STATE_MISMATCH', 'state_mismatch'],
    ['CONTINUATION_TOKEN_MISMATCH', 'invalid_token'],
    ['CONTINUATION_NOT_VERIFIED', 'invalid_token'],
    ['CONTINUATION_NOTHING_HELD', 'cancelled'],
    ['CONTINUATION_OFFLINE', 'offline'],
    ['CONTINUATION_CONFIG_STATUS_503', 'unavailable'],
    ['CONTINUATION_CONFIG_UNREADABLE', 'unavailable'],
    ['CONTINUATION_RECEIPT_PATH_REFUSED', 'unavailable'],
    ['CONTINUATION_REFUSED_SIGNED_IN', 'unavailable'],
    ['CONTINUATION_REFUSED_SIGNED_OUT', 'unavailable'],
    ['CONTINUATION_REFUSED_IN_FLIGHT', 'unavailable'],
    ['CONTINUATION_REFUSED_UPDATING', 'unavailable'],
    ['CONTINUATION_REFUSED_NOT_FIRST_LAUNCH', 'unavailable'],
