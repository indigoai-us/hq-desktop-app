...
<div class="widget-settings" data-loading={loading || undefined}>
  <div class="setting-row">
    <div class="setting-info">
      ...
      <span class="setting-desc">Show the floating stack on your desktop. Off never shows the stack; items still go to the desktop notifications list.</span>
    </div>
  ...
  {#if widgetEnabled}
    ...
    <div class="setting-row">
      <div class="setting-info">
        ...
        <span class="setting-desc">How long the stack stays up while you are in another app. Never keeps it until you hide it.</span>
      </div>
      <span class="setting-control">
    ...
    <div class="setting-row">
      <div class="setting-info">
        ...
        <span class="setting-desc">Meetings that still need a company stay in the stack. They will not keep the panel on top of other apps.</span>
      </div>
      <span class="setting-control">
