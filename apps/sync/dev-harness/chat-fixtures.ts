...
export function buildChatChannels(nowMs: number = Date.now()) {
  return [
    ...
    {
      // YESTERDAY day-group fixture (D-13).
      channelId: 'ch_design_crit',
      name: 'design-crit',
      scope: 'company',
      companyUid: 'cmp_indigo',
      companyName: 'Indigo',
      ...
      unread: 0,
      memberCount: 7,
      lastActivityAt: harnessDaysAgo(1, nowMs),
      lastMessageAt: harnessDaysAgo(1, nowMs),
      createdAt: '2026-04-20T12:00:00.000Z',
    },
    {
      // Weekday day-group fixture (D-13).
      channelId: 'ch_growth_loop',
      name: 'growth-loop',
      scope: 'company',
      ...
      unread: 0,
      memberCount: 6,
      lastActivityAt: harnessDaysAgo(3, nowMs),
      lastMessageAt: harnessDaysAgo(3, nowMs),
      createdAt: '2026-04-22T12:00:00.000Z',
    },
    // LAST WEEK collapse fixtures — 6 hidden items total incl. archive-notes
    // and the Alan Turing DM (D-14).
    ...[
      ['ch_lw_retro', 'retro-notes', 8],
      ['ch_lw_billing', 'billing-scope', 9],
      ['ch_lw_infra', 'infra-review', 11],
      ['ch_lw_launch', 'launch-recap', 12],
    ].map(([channelId, name, days]) => ({
      ...
      unread: 0,
      memberCount: 4,
      lastActivityAt: harnessDaysAgo(days as number, nowMs),
      lastMessageAt: harnessDaysAgo(days as number, nowMs),
