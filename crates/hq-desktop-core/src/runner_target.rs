...
mod tests {
    ...
    fn npx_cache_key_is_sha512_of_the_input_spec_and_changes_with_the_floor() {
        ...
        assert_eq!(
            npx_cache_entry_hash("@indigoai-us/hq-cloud@~6.16.21"),
            "ab930d0bfe76fedb",
        );
        assert_ne!(
            npx_cache_entry_hash("@indigoai-us/hq-cloud@~6.16.6"),
        ...
        // The manifest-upload floor bump: 6.16.21 already SATISFIES `~6.16.11`,
    ...
    fn runner_hq_cloud_version_reads_the_resolved_npx_entry_and_fails_soft() {
        ...
        write_runner(&entry, 0o755);
        write_hq_cloud_manifest(&entry, r#"{"version":"6.16.21"}"#);
        assert_eq!(runner_hq_cloud_version_in(&cache, &spec), "6.16.21");
        assert_eq!(
