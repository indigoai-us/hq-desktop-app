...
//! round-tripping to any vault. These helpers scan the resolved HQ folder and
...
pub fn read_registry(hq_root: &Path) -> Vec<RawWorkerEntry> {
...
pub fn sanitize_registry(raw: &str) -> String {
...
pub fn sanitize_registry_line(line: &str) -> String {
...
pub fn last_path_segment(path: &str) -> String {
...
pub fn worker_row(entry: &RawWorkerEntry, scope: &str, company: Option<String>) -> LibraryWorker {
...
pub fn collect_worker_yaml_files(dir: &Path, out: &mut Vec<PathBuf>) {
...
pub fn company_slugs(hq_root: &Path, registry: &[RawWorkerEntry]) -> Vec<String> {
...
/// core/ paths.
pub fn slug_from_worker_path(path: &str) -> Option<String> {
...
pub fn detect_pack(skill_dir: &Path) -> Option<String> {
...
/// clean `Vec<String>`.
pub fn normalize_tools(value: Option<&serde_yaml::Value>) -> Vec<String> {
    match value {
...
pub fn normalize_worker_skills(value: Option<&serde_yaml::Value>) -> Vec<WorkerSkillRef> {
...
pub fn normalize_instructions(value: Option<&serde_yaml::Value>) -> String {
    match value {
