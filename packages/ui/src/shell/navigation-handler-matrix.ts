...
export const DESKTOP_ROUTE_GRAMMAR_FILE =
  "apps/sync/src/desktop-alt/lib/route.ts";
...
export const NAVIGATION_HANDLER_MATRIX: readonly NavigationHandlerRow[] = [
  ...
  {
    id: "apply-inbox-deep-link",
    file: SHARED_SHELL_FILE,
    needle: "async function applyInboxDeepLink(",
    destinationKind: "passthrough",
    history: "push",
    host: "shared-shell",
    inScope: true,
  ...
  },
  {
    id: "dm-wake-live",
    file: SHARED_SHELL_FILE,
    needle: "async function applyDmWake(wake: {",
    destinationKind: "none",
    history: "none",
    host: "shared-shell",
    inScope: true,
  ...
  {
    id: "host-route-home",
    file: DESKTOP_ROUTE_GRAMMAR_FILE,
    needle: "case 'home':",
    destinationKind: "messages",
    history: "none",
    host: "hq-work-host",
    inScope: true,
    notes: "Parse only; delivery is applyDesktopAltRoute.",
  },
  {
    id: "host-route-inbox",
    file: DESKTOP_ROUTE_GRAMMAR_FILE,
  ...
  },
  {
    ...
    host: "hq-work-host",
    inScope: true,
    notes: "inbox:dm:<personUid> parse; shell selects the DM thread.",
  },
  {
    id: "host-route-inbox-channel",
    file: DESKTOP_ROUTE_GRAMMAR_FILE,
    needle: "if (detail === 'channel')",
    destinationKind: "channel",
    history: "none",
    host: "hq-work-host",
    inScope: true,
    notes: "inbox:channel:<channelId>[:<messageId>] parse; shell opens the channel.",
  },
  {
  ...
  {
    id: "host-parse-desktop-route",
    file: HQ_WORK_HOST_FILE,
    needle: "const parsed = parseDesktopRoute(route);",
    destinationKind: "passthrough",
    history: "none",
    host: "hq-work-host",
    inScope: true,
    notes: "Colon-grammar routes are parsed in lib/route.ts.",
  },
  {
