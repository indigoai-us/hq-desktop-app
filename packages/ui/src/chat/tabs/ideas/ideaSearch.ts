 ...
 *
 * SINGLE SOURCE. The legacy desktop-alt board re-exports this module rather
 * than keeping a second copy — two search indexes would drift, and the old
 * board's e2e suite is still the deepest coverage this logic has.
 */
