<script lang="ts">
   ...
   */
  import { companySettingsUrl } from "../common/hq-console";
  import {
  ...
  interface Props {
    slug: string;
    /** Adapter slices for the Claude Code workflow handoffs (deploy/secrets). */
  ...
  const activeDestination = $derived<CompanyOperationsTab>(
    destinations.some((d) => d.id === destination)
      ? destination
      : DEFAULT_COMPANY_OPERATIONS_TAB,
  );
  ...
  >
    ...
    >
      ...
      {:else if activeDestination === "secrets"}
        <SecretsPanel {slug} {workflow} {cloudBacked} {syncEnabled} />
      {:else}
        <section
          class="ops-settings"
        ...
        >
          <header class="ops-settings-header">
            <div class="title-stack">
              <h2 id="ops-settings-title" class="ops-settings-title">
                Company settings
              </h2>
          ...
          <div class="ops-settings-list" data-testid="operations-settings-list">
            <div class="ops-settings-row">
              <span class="ops-settings-row-copy title-stack">
                ...
                <span class="ops-settings-row-meta"
                  >Company name, slug, and cloud membership</span
                >
              </span>
              <button
                type="button"
            ...
            <div class="ops-settings-row">
              <span class="ops-settings-row-copy title-stack">
                ...
                <span class="ops-settings-row-meta"
                  >What syncs for this company vault</span
                >
              </span>
              <button
                type="button"
