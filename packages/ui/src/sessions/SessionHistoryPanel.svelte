<script lang="ts">
  ...
  const filtered = $derived(
    filterHistory(sessionsStore.history, {
      tool: toolFilter,
...
<section class="hi" aria-label="History">
  ...
  {#if sessionsStore.unavailable}
    ...
    <div class="hi-empty" data-testid="sessions-unavailable" role="status">
      <p class="hi-empty-title">Not available here</p>
        ...
        <li class="hi-item">
          ...
          <div class="hi-body">
            ...
            <div class="hi-meta">
              ...
              {/if}
              <span class="hi-meta-time"
                >{relativeActivity(event.timestamp, now)}</span
              >
            </div>
          </div>
        </li>
