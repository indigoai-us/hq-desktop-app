...
describe("friendlyPath", () => {
  it("collapses a POSIX home prefix", () => {
    ...
    expect(friendlyPath("/Users/ada/Documents/HQ", "/Users/ada/")).toBe(
      "~/Documents/HQ",
    );
  });
  ...
  it("does not collapse a partial home prefix match", () => {
    expect(friendlyPath("/Users/ada-work/hq", "/Users/ada")).toBe(
      "/Users/ada-work/hq",
    );
  });
  ...
  it("handles Windows-style paths", () => {
    ...
    expect(friendlyPath("C:\\Users\\Ada2\\hq", "C:\\Users\\Ada")).toBe(
      "C:\\Users\\Ada2\\hq",
    );
  });
...
describe("homeDirFromDefaultHqPath", () => {
  it("derives the home directory from a default HQ path", () => {
    ...
    expect(homeDirFromDefaultHqPath("C:\\Users\\Ada\\HQ")).toBe(
      "C:\\Users\\Ada",
    );
  });
...
describe("directory primary action", () => {
  it("uses an existing HQ instead of installing over it", () => {
    expect(directoryPrimaryAction(true)).toBe("use");
    expect(directoryPrimaryLabel(true)).toBe("Use this HQ");
    expect(directoryPrimaryAction(false)).toBe("install");
    expect(directoryPrimaryLabel(false)).toBe("Install");
  });
});
