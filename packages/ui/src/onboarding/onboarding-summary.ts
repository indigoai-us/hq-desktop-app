...
export interface PrimaryLaunch {
  kind: PrimaryLaunchKind;
  label: string;
}
...
export function readyCommandFor(
  path: string | null,
  tools: AiTools | null,
): string {
  ...
  const available = [
    {
      ...
      available: tools.claude_cli || tools.claude_desktop,
      used: tools.claude_last_used_ms,
    },
    {
      kind: "codex" as const,
      label: "Open in Codex",
      available: tools.codex_cli || tools.codex_desktop,
      used: tools.codex_last_used_ms,
    },
    {
      kind: "grok" as const,
      label: "Open in Grok",
      available: tools.grok_cli,
      used: tools.grok_last_used_ms,
    },
