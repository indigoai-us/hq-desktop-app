 ...
 *
 * Re-exported from ../chat/brand.js so the shell's `Workspace.brand` rows and
 * this runtime speak one type rather than two structurally-similar ones.
 */
export type { CompanyBrandSettings } from '../chat/brand.js';
import type { CompanyBrandSettings } from '../chat/brand.js';
